 ...
 */
?>
<article id="product-<?php print $product->nid; ?>" class="<?php print implode(' ', $classes); ?> clearfix"<?php print backdrop_attributes($attributes); ?>>

  <?php print render($display_price); ?>
  <?php print render($model); ?>
  <?php print render($list_price); ?>
  <?php print render($cost); ?>
  <?php print render($sell_price); ?>
  <?php print render($weight); ?>
  <?php print render($dimensions); ?>
